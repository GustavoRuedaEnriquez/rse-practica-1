...
#define EXAMPLE_MQTT_CLIENT_ID "MQTT adc led values"
...
static const struct mqtt_connect_client_info_t mqtt_client_info = {
    ...
    .client_user = "sofmich",
    .client_pass = "aio_Yzil15rWUigtrkhmJbGf6tMUiByC",
    .keep_alive  = 100,
    .will_topic  = NULL,
    .will_msg    = NULL,
    .will_qos    = 0,
...
{
    static const char *topics[] = {"sofmich/feeds/led", "sofmich/feeds/ADC values"};
    int qos[]                   = {1, 1};
    err_t err;
    int i;
...
{
    static const char *topic   = "sofmich/feeds/ADV values";
    static const char *message = "ADC value :";
